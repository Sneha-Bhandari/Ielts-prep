    ...
    <>
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/mock-tests" element={<MockTestDashboard />} />
          {/* Core Categories */}
          ...
          <Route
            path="/courses/course/:entityId/section/:sectionId"
            element={<AddLesson />}
          />
          ...
          <Route path="/mock-tests/:id/modules" element={<ModuleSelection />} />
          ...
          <Route
            path="/studentIelts/course/:courseId"
