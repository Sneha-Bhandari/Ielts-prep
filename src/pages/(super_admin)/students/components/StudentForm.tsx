            ...
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-6">
                  {avatarPreview ? (
                    <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-slate-200 bg-slate-50 group">
                      <img
                        src={avatarPreview}
                    ...
                    <div
                      className={`relative w-24 h-24 flex flex-col items-center justify-center border-2 border-dashed rounded-full cursor-pointer transition-all duration-200 ${
                        uploadingAvatar
                  ...
                  />
                  <div>
                    <p className="text-sm text-slate-600">Upload student photo</p>
